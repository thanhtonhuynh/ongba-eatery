...
export function JoinOurTeam() {
  return (
    <section className="bg-secondary text-wine space-y-6 p-3 sm:p-6">
      <OrnamentLine starSrc="/star-filled-wine.svg" color="wine" size="half" />
      ...
      <div className="flex flex-col items-center gap-6 pb-3 sm:gap-8 sm:p-6">
        ...
        <Image src={LogoWine} alt="Ongba's Logo" className="h-40 w-auto sm:h-52 md:h-60" />
